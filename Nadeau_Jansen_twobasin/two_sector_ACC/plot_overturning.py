...
#case=('diags/kapx2.npz',-0.0011,1e-4,'2basin_kapx2') # parameters are (filename, bbot, f) 
case=('ref_new.npz',-0.0011,1e-4,'2basin_ref_new') # parameters are (filename, bbot, f) 
...
bticks=[0.02, 0.005,0.002,0.001, 0.0005, 0., -0.001]
#bticks=[0.02, 0.005,0.002,0.001, 0.,-0.001,-0.002,-0.004]
...
#offset=0.0345*(1-np.cos(np.pi*(-1.e5)/8e6));
...
#Psi_atl_ad=np.interp(b_Atl,AMOC.bgrid,Psi_ad);
...
# Plot diabatic Isopycnal overturning
...
#plt.savefig(path+case[3]+'_b_dia.png', format='png', dpi=400)
...
#plt.savefig(path+case[3]+'_b_adia.png', format='png', dpi=400)
