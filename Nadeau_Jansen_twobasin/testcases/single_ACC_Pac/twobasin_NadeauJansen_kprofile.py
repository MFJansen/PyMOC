...
for ii in range(0, total_iters):    
   ...
   wA_Atl=(Psi_iso_Atl+Psi_zonal_Atl)*1e6
   wAN=-Psi_iso_N*1e6
   wA_Pac=(-SO.Psi-Psi_zonal_Pac)*1e6
...
for iy in range(len(y),len(y)+len(ybasin)):
    ...
    psiarray_z_Atl[iy,:]=((ynew[iy]-lchannel)*AMOC.Psi+(lchannel+lbasin-ynew[iy])*(-ZOC.Psi))/lbasin  
    psiarray_z_Pac[iy,:]=((lchannel+lbasin-ynew[iy])*(ZOC.Psi+SO.Psi))/lbasin  
    ...
    psiarray_Atl[iy,:]=((ynew[iy]-lchannel)*AMOC.Psibz(nb=nb)[0]+(lchannel+lbasin-ynew[iy])*(-ZOC.Psibz()[0]))/lbasin   
    psiarray_b_Atl[iy,:]=((ynew[iy]-lchannel)*AMOC_bbasin-
                         (lchannel+lbasin-ynew[iy])*(
                          np.interp(b_basin,ZOC.bgrid,ZOC.Psib())))/lbasin   
    psiarray_b_Atl_ad[iy,:]=psiarray_b_ad[iy,:]
    psiarray_Pac[iy,:]=((lchannel+lbasin-ynew[iy])*(ZOC.Psibz()[1]+SO.Psi))/lbasin   
    psiarray_b_Pac[iy,:]=((lchannel+lbasin-ynew[iy])*(
                        np.interp(b_basin,ZOC.bgrid,ZOC.Psib())+
                        np.interp(b_basin,Pac.b,SO.Psi)))/lbasin   
...
ax1.plot(AMOC.Psi, AMOC.z,'--r', linewidth=1.5)
ax1.plot(ZOC.Psi, ZOC.z, ':c', linewidth=1.5)
ax1.plot(ZOC.Psi, SO.z, '--b', linewidth=1.5)
ax1.plot(ZOC.Psi+SO.Psi, ZOC.z, '--g', linewidth=1.5)
...
#ax1.plot(SO_Pac.Psi, SO_Pac.z, ':g', linewidth=1.5)
ax1.plot(ZOC.Psi, ZOC.z, ':c', linewidth=1.5)
ax1.plot(-ZOC.Psibz()[0], SO.z, '--b', linewidth=1.5)
ax1.plot(ZOC.Psibz()[1]+SO.Psi, ZOC.z, '--g', linewidth=1.5)
...
ax1.plot(-np.interp(b_basin,ZOC.bgrid,ZOC.Psib()), z, '--b', linewidth=1.5)
ax1.plot(np.interp(b_basin,Pac.b,SO.Psi)+np.interp(b_basin,ZOC.bgrid,ZOC.Psib()), z, '--g', linewidth=1.5)
ax1.plot(PsiSO, z, '--k', linewidth=1.5)
ax2.plot(Atl.b, Atl.z, '-b', linewidth=1.5)
ax2.plot(Pac.b, Pac.z, '-g', linewidth=1.5)
ax2.plot(north.b, north.z, '-r', linewidth=1.5)     
