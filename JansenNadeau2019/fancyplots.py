...
# -*- coding: utf-8 -*-
"""
This script makes fancy looking 2D plots of the colusomn model solution.
...
fig.tight_layout()   
#fig.savefig('psi_b_2D_depth_adiabatic.png', format='png', dpi=600)
...
fig.colorbar(CS, ticks=plevs[0::5], orientation='vertical')
fig.tight_layout()  
#fig.savefig('psi_b_2D_iso_adiabatic.png', format='png', dpi=600)
...
fig.tight_layout()
#fig.savefig('profiles_adiabatic.png', format='png', dpi=600)
...
fig.tight_layout()   
#fig.savefig('bs_Psi_SO_adiabatic.png', format='png', dpi=600)
